...
<head>
  <meta charset="UTF-8">
  <title>Alta de biblioteca</title>
...
<body>
 ...
 <nav>
    <div class="nav-wrapper red lighten-1 z-depth-1">
      <a href="../index.html" class="brand-logo">Biblioteca</a>
          ...
          <div class="row">
            <div class="section">
              <div class="input-field col s6">
                ...
                <input type="text" id="titulo" name="titulo" class="validate" placeholder="Arrancar con HTML5" autofocus="autofocus">
              </div>
              <div class="input-field col s6">
                <label for="editorial">Editorial</label>
                <input type="text" id="editorial" name="editorial" class="validate" placeholder="Alfaomega">
              </div>
              <div class="input-field col s6">
                <label for="autor">Autor</label>
                <input type="text" id="autor" name="autor" class="validate" placeholder="Emmanuel Herrera Rios">
              </div>
              <div class="input-field col s6">
                <label for="isbn">ISBN</label>
                <input type="text" id="isbn" name="isbn" class="validate" placeholder="978-0-7334-2609-4">
              </div>
              <div class="input-field col s6">
                <label for="tematica">Tematica</label>
                <input type="text" id="tematica" name="tematica" class="validate" placeholder="Alfaomega">
              </div>
            </div>
          </div>
          <!--Botón-->
